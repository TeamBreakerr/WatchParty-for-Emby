...
function createHarness({ isSeriesParty, seasonId = '', episodeId = '' }) {
    ...
    add('newMaxParticipants', { value: '10' });
    add('newPartyPassword', { value: '' });
    add('newMasterUser', { value: 'master-user' });
    add('newAllowedUsers', { selectedOptions: [] });
    add('newIsActive', { checked: true });
    add('newWaitingRoom', { checked: true });
    add('newAutoStart', { checked: true });
    add('newMinReady', { value: '2' });
    add('newPauseControl', { value: 'Anyone' });
    add('newHostOnlySeek', { checked: true });
    add('newLockSeekAhead', { checked: true });
    add('newSyncTolerance', { value: '10' });
    add('newMaxBuffer', { value: '30' });
    add('newAutoKick', { checked: true });
    add('newInactiveTimeout', { value: '15' });
    add('newEnableNetworkLatencyCompensation', { checked: true });
    add('newNetworkLatencyMeasurementIntervalSeconds', { value: '30' });
    add('newAutoAdjustForLatency', { checked: true });
    add('newMaxLatencyCompensationMs', { value: '5000' });
