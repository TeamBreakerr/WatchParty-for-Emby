...
- **Session-Safe Recovery** — Multiple devices per account, delayed stop/progress events, missing start events, and episode changes are isolated by session and playback ID
